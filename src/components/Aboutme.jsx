...
const Aboutme = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="  flex w-11/12 flex-col gap-4 rounded-xl  bg-cinereous  p-5 border-t-2 border-b-2 border-liver  transition duration-1000 hover:scale-105 hover:transition hover:duration-1000 lg:w-8/12 lg:flex-row">
          <div className=" w-full lg:w-1/2 ">
            <img className="rounded-lg  brightness-110 " src={photo} alt="photo" />
          </div>
          <div className=" flex w-full  flex-col items-center justify-between lg:w-1/2">
            <div>
              ...
              <div className=" flex flex-col gap-4 rounded-lg bg-white bg-opacity-20 p-4 text-center text-white border-b-2 border-t-2 border-liver">
