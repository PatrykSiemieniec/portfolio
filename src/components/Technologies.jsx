...
const Technologies = () => {
  ...
  return (
    <div
      id="technologies"
      className=" relative flex h-auto w-full flex-col items-center justify-center gap-4 bg-cinereous p-6 lg:h-screen lg:flex-row "
    >
      ...
      <a
        href="#projects"
        className="animate-bounce cursor-pointer    p-6 text-liver md:p-0 lg:absolute lg:bottom-[40px]"
      >
...
const TechnologySection = forwardRef(({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[200px] flex-col items-center justify-evenly rounded-lg bg-white bg-opacity-20 p-4 shadow-sm shadow-white drop-shadow-lg lg:w-2/5"
    >
